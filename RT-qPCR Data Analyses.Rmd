...
InputPath1 = "./20230622_ELG_TGFBTC_TR1_depurated.txt"

InputPath2 = "./20230622_ELG_TGFBTC_tr2_depurated.txt"

InputPathTreatmentFile = "./Treatment_Table.txt"


qPCR_table1 <- read.table(InputPath1, fill = TRUE)

qPCR_table2 <- read.table(InputPath2, fill = TRUE)
